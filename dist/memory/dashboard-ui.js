...
exports.createDashboardUI = createDashboardUI;
 ...
 */
function createDashboardUI(stats, options) {
    // Create screen
 ...
 */
function createHeader(parent, options) {
 ...
 */
function createSummaryPanel(parent, stats) {
 ...
 */
function createGrowthChart(parent, stats) {
 ...
 */
function createSectionPieChart(parent, stats) {
 ...
 */
function createConfidenceBarChart(parent, stats) {
 ...
 */
function createEvidenceBarChart(parent, stats) {
 ...
 */
function createActiveAgentsTable(parent, stats) {
 ...
 */
function createExpiryTable(parent, stats) {
 ...
 */
function createRecentOperationsTable(parent, stats) {
 ...
 * Requirements: 23.10
 */
function setupKeyboardShortcuts(screen, options) {
    // 'q': Quit dashboard
    screen.key(['q', 'C-c'], () => {
        if (options.onQuit) {
            options.onQuit();
 ...
 */
function getStaleEvidenceColor(count) {
